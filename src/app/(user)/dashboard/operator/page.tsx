    ...
    <div>
      <div className="mx-auto max-w-4xl">
        <div className="text-center my-8 space-y-2">
          <h1 className="text-3xl font-bold">Gestión de Resultados</h1>
          <p className="text-neutral-700">
            Selecciona un torneo para actualizar sus resultados y sus goleadores
          </p>
        </div>
          ...
          {tournaments.map((tournament) => (
            <Card key={tournament.id} className="mb-4">
              ...
              <CardContent className="space-y-2">
                ...
                <ButtonLink
                  href={`/dashboard/operator/${tournament.id}`}
                  className="w-full"
                >
                  Editar Partidos
                </ButtonLink>
