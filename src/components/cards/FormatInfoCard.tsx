...
export default function FormatInfoCard() {
  return (
      ...
      <CardContent className="p-4">
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-secondary-800">
            ...
            <p className="mt-2">
              <strong>Columnas requeridas:</strong> NOMBRE, CANTIDAD_JUGADORES
            </p>
            <p className="mt-1">
              <strong>Columna opcional:</strong> LOGO (URL del logo del equipo)
            </p>
          </div>
        </div>
      </CardContent>
